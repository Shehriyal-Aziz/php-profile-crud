...
<body>
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class=" mt-5 h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
...
<div class="main-content">
    ...
    <!-- cgfnd -->
    <h2 class="mt-2" >feedback by users</h2>
    <table>
        <tr>
            <th>Name</th>
            <th>Email</th>
        ...
        ?>
            <tr>
                <td><?php echo $feed['f_name'] ?></td>
                <td><?php echo $feed['f_email'] ?></td>
                <td><?php echo $feed['f_message'] ?></td>
            </tr>
        <?php
        }
        ?>
